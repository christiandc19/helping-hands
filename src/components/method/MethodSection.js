  ...
  return (
    <>
      ...
      <div className="container treatment-section-overview">
        ...
        <p>
          Here at Helping Hands Rehab, we firmly stand that without addressing
          ...
          <br />
          <br />
          Methods used by Helping Hands Rehab are non-invasive, distinct, and
      ...
      <div className="treatment-section-activities">
        <div className="treatment-left">
          ...
          <p>
            Helping Hands Rehab promotes fun activities that clients learn how
